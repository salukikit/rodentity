...
// The LootFunc type is an adapter to allow the use of ordinary
// function as Loot mutator.
type LootFunc func(context.Context, *ent.LootMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LootFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LootMutation); ok {
		return f(ctx, mv)
	}
...
// The RodentFunc type is an adapter to allow the use of ordinary
// function as Rodent mutator.
type RodentFunc func(context.Context, *ent.RodentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RodentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RodentMutation); ok {
		return f(ctx, mv)
	}
